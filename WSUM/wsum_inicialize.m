function [x,y]=wsum_inicialize(x0,w,problem) 
...
switch problem
    ...
    case 'TAPPETA'
        ...
        eqh=[];
        [x,y] =fmincon(@(x0)wsum_comfun(x0,w,fhandles),x0,[],[],[],[],[0 0 0],[10 10 10],@(x)constraints_wsum(x,ineqh,eqh),opt); %x,fnum,fhandles,ineqh, eqh, ub
    ...
    case 'DOWNING'
        ...
        eqh=[];
        [x,y] =fmincon(@(x0)wsum_comfun(x0,w,fhandles),x0,[],[],[],[],[0 0 0 0 0],[5 5 5 5 5],@(x)constraints_wsum(x,ineqh,eqh),opt); %x,fnum,fhandles,ineqh, eqh, ub
    ...
    case 'VINNET'
        ...
        ineqh=[];
        eqh=[];
        [x,y] =fmincon(@(x0)wsum_comfun(x0,w,fhandles),x0,[-1 0;0 1],[2;2],[],[],[-6 -6],[6 6],@(x)constraints_wsum(x,ineqh,eqh),opt); %x,fnum,fhandles,ineqh, eqh, ub
    ...
    case 'VINNET2'
        ...
        ineqh=[];
        eqh=[];
        [x,y] =fmincon(@(x0)wsum_comfun(x0,w,fhandles),x0,[-1 0;0 1],[4;4],[],[],[-6 -6],[6 6],@(x)constraints_wsum(x,ineqh,eqh),opt); %x,fnum,fhandles,ineqh, eqh, ub
    ...
    case 'RENDON'
        ...
        ineqh=[];
        eqh=[];
        [x,y] = fmincon(@(x0)wsum_comfun(x0,w,fhandles),x0,[-1 0; 0 1],[3; 3],[],[],[-6 -6],[6 6],@(x)constraints_wsum(x,ineqh,eqh),opt); %x,fnum,fhandles,ineqh, eqh, ub
